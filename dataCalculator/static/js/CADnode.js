...
function showProperties(node, nodeId){
    ...
    $('#form-node')[0].style.display = "block";
...
nodeData = function(color, typename, nodetxt, nodename, nodeid){
...
createInstance = function(position, color, shortName, id) {
    ...
    var instance = nodeData(color,'devs.it', shortName, 'Instance', nodeId);
